...
export default async function NewWorkOrderPage({params}: NewWorkOrderPageProps) {
  const {id: projectId} = await params

  const [employeesFromDAL, hourTypes, materialsFromDAL, profile] = await Promise.all([
    getEmployees(),
    getHourTypes(),
    getMaterials(),
