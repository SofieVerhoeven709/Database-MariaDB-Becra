...
import {updateWorkOrderAction} from '@/serverFunctions/workOrders'
import type {WorkOrderDetailData} from '../../mapper/workOrders'
import {formatDate, thClass, toInputDate} from '../../mapper/workOrderHelpers'
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-foreground">{workOrder.workOrderNumber ?? 'Work Order'}</h1>
