...
function mapApplicant(applicant: RecruitmentApplicantWithRelations): RecruitmentApplicant {
  return {
    ...
    contactType: applicant.contactType as RecruitmentContactType,
...
function mapVacancy(vacancy: RecruitmentVacancyWithRelations): RecruitmentVacancy {
  return {
    ...
    contractType: vacancy.contractType as RecruitmentContractType,
    workRegime: vacancy.workRegime as RecruitmentWorkRegime,
