...
export function mapDocument(d: DocumentListPayload): MappedDocument {
  ...
  return {
    ...
    documentGroupBId: d.documentGroupBId,
    documentGroupBName: d.DocumentGroupB.name,
    documentGroupCId: d.documentGroupCId,
    documentGroupCName: d.DocumentGroupC.name,
    documentGroupDId: d.documentGroupDId,
    documentGroupDName: d.DocumentGroupD.name,
