...
export const createPurchaseSchema = z.object({
  ...
  bocCustomerName: z.string().max(255).nullable().optional(),
  bocDescription: z.string().nullable().optional(),
  bocCreatedAt: z.string().nullable().optional(),
  bocStatus: z.string().max(50).nullable().optional(),
