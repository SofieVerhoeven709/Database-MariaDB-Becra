...
ALTER TABLE DocumentStructure ADD IF NOT EXISTS documentGroupAId CHAR(36) NOT NULL,
...
ALTER TABLE DocumentStructure ADD IF NOT EXISTS documentGroupBId CHAR(36) NULL,
...
ALTER TABLE DocumentStructure ADD IF NOT EXISTS documentGroupCId CHAR(36) NULL,
...
ALTER TABLE DocumentStructure ADD IF NOT EXISTS documentGroupDId CHAR(36) NULL,
...
ALTER TABLE DocumentStructure ADD IF NOT EXISTS documentPlaceId CHAR(36) NOT NULL,
